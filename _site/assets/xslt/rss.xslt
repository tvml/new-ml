...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Machine learning</a></h1>
    </li>
		...
		<div class="row">
			<div class="small-12 columns">
				...
				<p style="text-align:center;">
					<img src="http://localhost:4000/assets/img/" alt="Machine learning – Università di Roma Tor Vergata">
				</p>
				</a>
